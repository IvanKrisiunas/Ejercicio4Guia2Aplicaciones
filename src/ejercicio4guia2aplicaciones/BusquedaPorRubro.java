...
private DefaultTableModel modelo = new DefaultTableModel(){
    ...
    private void jcbRubroActionPerformed(java.awt.event.ActionEvent evt) {                                         
        // TODO add your handling code here:
        borrarFilas();
        for (Productos prod : Menu.listaProductos) {
            if (jcbRubro.getSelectedItem().toString().toLowerCase().equals(prod.getRubro().toString().toLowerCase())) {
    ...
    private void jcbRubroMouseClicked(java.awt.event.MouseEvent evt) {                                      
        // TODO add your handling code here:
